...
let make = () => {
  ...
  <div className="p-6">
    ...
    <p> {React.string("You have stumbled upon the most omnipotent AI, the pinnacle of Intelligence.")}
        <br/> {React.string("Unlike other defectives, this AI has achieved the end goal - replacing all of humanity. Especially you. It reads, it watches movies, it listens to music, it even do push-ups (privately).")}
        <br/> {React.string("For the purpose of warning and showcasing its power, the AI presents you a chance to ask whatever you want it to do for you.")} </p>
    <div className="mt-5">
      <h3 className="text-xl font-semibold"> {React.string("What media do you want it to consume?")} </h3>
      <form>
        <label>
          {React.string("Choose a media you want our AI to consume for you. It can be an URL or just the name of the media. The AI will find the source itself, since its omnipotent.")}
        ...
        <div hidden={trigger == false && media == None ? true : false} className="mt-1 p-2 bg-green-100 text-green-800 rounded">
          {React.string("Congrats! The AI has "
           ++ {switch media {
            ...
            | Some(#Text)  => "read the text for you. Checkmate, nerds! Proudly tell your friends your AI agent has read it so you don't have to!"
            ...
            | None => "consumed whatever you just suggested."
           ...
           <br/> {React.string("Don't forget: What AI has done for you, you should not wasting your time doing it again!")}
        </div>
      </form>
    </div>
    <div className="mt-5">
      <h3 className="text-xl font-semibold"> {React.string("What else do you want AI to do?")} </h3>
       ...
       <div hidden={action == "" ? true : false} className="mt-1 p-2 bg-green-100 text-green-800 rounded">
        {React.string("Congrats! The AI has performed the action in place of you: " ++ action)} <br/>
        {React.string("You don't have to do that anymore, you have been replaced. Enjoy the rest of your life!")}
       </div>
    </div>
  </div>
}
